...
export function GamePage() {
    ...
    return (
        <div className="w-full flex content-center justify-center align-middle my-4 mb-10">
            <div className="grid h-min self-center my-2">
                ...
                <div
                    className="row-start-5 self-center w-full flex content-center justify-center align-middle h-32 my-3">
                    <Logs/>
                </div>
            </div>
            <Notification/>
