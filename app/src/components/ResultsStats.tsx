...
export function ResultsStats() {
    ...
    return results ?
        <div className="py-2 px-2 rounded h-min self-center m-2 grid bg-white">
            <div className="py-2 px-2 rounded bg-blue-100 row-start-1 w-full m-1">
                Your score: {isOwner ? results.ownerScore : results.competitorScore}
            </div>
            <div className="py-2 px-2 rounded bg-rose-100 row-start-2 w-full m-1">
